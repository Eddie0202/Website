            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="register1.php">Người Dùng</a>
                        <a class="collapse-item" href="register.php">Quản Trị Viên</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="bookList.php">Xem Và Chỉnh Sửa</a>
<!--                         <a class="collapse-item" href="#">Chỉnh Sửa Mặt Hàng</a>
                        <a class="collapse-item" href="../addproduct.php">Thêm Mặt Hàng</a> -->
                        <a class="collapse-item" href="addMovie.php">Thêm Phim</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseReviews" class="collapse" aria-labelledby="headingReviews"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="addReview.php">Viết Bài Đánh Giá</a>
                        <a class="collapse-item" href="review_list.php">Chỉnh Sửa Bài Đánh Giá</a>
                    </div>
                </div>
            </li>
